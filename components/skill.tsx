...
const Skill = () => {
  return (
    <>
      <section id="skill" className="bg-[#20242D] min-h-screen py-10">
        <h1 className={`${lusitana.className} text-center font-bold text-4xl text-[#E9E6E5] py-6 md:py-9`}>
          My <span className="font-bold text-3xl text-[#02E5F2]">Skills</span>
        </h1>
